...
class ConfigurationManager:
    ...
    def get_data_validation_config(self) -> DataValidationConfig:
        ...
        data_validation_config = DataValidationConfig(root_dir = config.root_dir, STATUS_FILE = config.STATUS_FILE, unzip_data_dir = config.unzip_data_dir, all_schema = schema)
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        ...
        model_evaluation_config = ModelEvaluationConfig(root_dir = config.root_dir,
                                                        ...
                                                        target_column = schema.name,
                                                        mlflow_uri = "https://dagshub.com/Luminousbyte/DataScienceProject.mlflow")
